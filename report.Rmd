...
#most population has studied for management&commerce, Not stated seems to dominate the map, however population is concentrated in the green region
...
bestfield %>%
  ...
  labs(title = "Region and Best Field", y = "Number of Students") +
  scale_y_continuous(label=label_number()) +
  coord_flip()  +
  theme(legend.position = "none")
```