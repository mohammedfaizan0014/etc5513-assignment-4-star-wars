...
\begin{figure}[H]
\includegraphics[width=6in, height = 6in]{Figures/}
\includegraphics[width=6in, height = 6in]{Figures/}
\includegraphics[width=6in, height = 6in]{Figures/}
\includegraphics[width=6in, height = 6in]{Figures/}
...
\begin{figure}[H]
\includegraphics[width=6in, height = 2in]{Figures/}
...
A network plot is a representation of the relationship between vertices and the strength of this relationship is determined by the edge weight(width, opacity, length, etc). In order to understand the relation between the topics and the age, the Figure \ref{fig:networktopicage} is a network plot representing the relationships between the sub-divisions within each topic and the age of the people. First inferences from these networks are:
