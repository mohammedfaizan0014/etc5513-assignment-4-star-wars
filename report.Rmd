...
```{r edu_gender, fig.cap = "Education level count by gender", include = FALSE}}
...
The figure \@ref{fig:edu_gender} indicates the Australian Qualifications Framework(AQF) levels of SA4 residents at Census night.
...
- Most of the Male achieved at the level 3 & 4, and both theoretical and practical knowledge and skills for work and/or further learning will have when graduate at this level. Compare to level 3, level 4 will more concentrate on specialised and/or skilled work.

- Level 1 & 2 has the lowest count in SA4 which is good as in this level, graduates only have the foundation knowledge for daily life and work.
...
```{r popareafield, fig.cap="Population distribution of field", include = FALSE}
popareafield <- g47 %>%
...
```
The figure \@ref{fig:popareafield} indicates the population distribution about the field of SA4 residents at Census night.

- Not stated seems to dominate the map, however, population is concentrated in the green region.

- Therefore management & commerce is the field that the most population have studied. 


```{r bestfield, fig.cap="Best field of each region", include = False}
...
The figure \@ref{fig:bestfield} indicates the most popular field of SA4 residents in each region at Census night.
